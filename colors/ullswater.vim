...
let g:ullswater_bold = get(g:, '_bold', 0)
  ...
  hi DiffDelete guifg=NONE ctermfg=NONE guibg=#79313c ctermbg=237 gui=NONE cterm=NONE
  ...
  hi Search guifg=#ffffff ctermfg=15 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
